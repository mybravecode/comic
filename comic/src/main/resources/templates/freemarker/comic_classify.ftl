...
<table width="1024" height="48" border="0" align="center" cellpadding="0" cellspacing="0" class="t1">
  <tr>
    <td width="168" height="42" align="center" class="STYLE33" >类型：</td>
    <td width="168" align="center"><a href="/comic/classify?j=1">搞笑</a></td>
    <td width="168" align="center"><a href="/comic/classify?j=2">热血</a></td>
    <td width="168" align="center"><a href="/comic/classify?j=3">励志</a></td>
    <td width="168" align="center"><a href="/comic/classify?j=4">情感</a></td>
    <td width="168" align="center"><a href="/comic/classify?j=5">冒险</a></td>
    <td width="168" ></td>
    <td width="168" ></td>
    <td width="168" ></td>
    <td width="168" ></td>
