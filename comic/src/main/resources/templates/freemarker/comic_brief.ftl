...
<td width="310" ></td>
     ...
     <img src="/static/image/${comic.picture}" alt="$$$$" height="372" align="top" />
         <p> ${comic.name} </p>
         <p> ${comic.message} </p>
         <p><a href="/collection/add?comicId=${comic.id}&comicName=${comic.name}&comicPic=${comic.picture}">收藏</a></p>
